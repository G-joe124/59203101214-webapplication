...
//count all patients from database
	$sql = "SELECT bususe.busno, bususe.drvid , bususe.dte, bususe.timestr, bususe.timestrp as pr 
			FROM bususe";
	...
	echo "<center>";
    echo "<h2>REPORT BUS USE FORM</h2><br />";
    echo "<form action='rptBusUse.php' method='post' name='search'>";
...
$search = $_POST[search];
	...
	echo "<font size='5' color='black'>รายงานสรุปการใช้รถประจำวันที่ : [ $search ] </font><br/>";
    $n=0;
