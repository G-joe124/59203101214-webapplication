...
<table>
<tr><th><h3>Insert Driver Form</h3><th></tr>
<!-- <tr><td>Driver ID: </td><td><input type="text" name="drvid" value=''></td></tr> -->
<tr><td>First Name: </td><td><input type="text" class="form-control" name="fnme"></td></tr>
<tr><td>Last Name: </td><td><input type="text" class="form-control" name="lnme"></td></tr>
...
<tr><td>Tel no: </td><td><input type="text" class="form-control" name="tel"></td></tr>
<tr><td>licen No: </td><td><input type="text" class="form-control" name="licenNo"></td></tr>
<tr><td>E-mail: </td><td><input type="email" class="form-control" name="email"></td></tr>
<!-- <tr><td>Pass word: </td><td><input type="text" name="pwd"></td></tr>
<tr><td>register date: </td><td><input type="text" name="rigisdte"></td></tr> -->
<tr><th colspan="2"><center><input type="submit" class='btn btn-primary' name="insdriver" value="Insert"></center></th></tr>
</tr>
</table><br>

<!-- </table><br><input type="submit" class="btn btn-primary" name="insdriver" value="Insert"> -->
</form>
</center>
</body>
</html>