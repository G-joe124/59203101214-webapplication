...
//array_push คือการนำค่าที่ได้จาก sql ใส่เข้าไปตัวแปร array
 array_push($dte,$row[dte]);
 array_push($amount,$row[sumamount]);
}
?>
<!DOCTYPE HTML>
<html>
...
<script>
 $(function () {
        $('#container').highcharts({
            ...
            xAxis: {
                categories: ['<?= implode("','", $dte); //นำตัวแปร array แกน x มาใส่ ในที่นี้คือ เดือน?>']
            },
            yAxis: {
                title: {
   ...
   legend: {
            ...
            series: [{
                                name: '',//พ.ศ.2556จำนวนผู้ใช้บริการตามวันที่
   ...
   legend: {
            ...
            series: [{
                                name: '',//จำนวนผู้ใช้บริการตามวันที่
                                data: [<?= implode(',', $amount) // ข้อมูล array แกน y ?>]
                            }]
        });
    });
    ...
    <body>
      <?php echo"<center><font size='5' color='#001a4d'>กราฟแสดงสรุปจำนวนผู้ใช้บริการของแต่ละวัน</font><br/></center>";?>
